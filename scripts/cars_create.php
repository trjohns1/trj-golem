...
* cars_create
*
* Sample script for the cars application. Allows the user to create a new
* car entry and store it in the database.
*/

	/**
	* cars_create
	*
	* This script displays a simple form, validates user input, and creates
	...
	*/
	function trj_golem_get_page_data($trj_golem_data) {
		...
		$trj_golem_data['script']['form']['trj_golem_make']->multiple=false;
			...
			$trj_golem_data['script']['form']['trj_golem_make']->options['option3']->selected=false;
			// Set attributes
		...
		$trj_golem_data['script']['form']['trj_golem_auto']->checked=true;
	...
	*/
	function trj_golem_process_save($trj_golem_data) {
		...
		// Get the id of the new record that was just created.
	...
	*/
	function trj_golem_prep_view($trj_golem_data) {
		...
		$trj_golem_data['script']['form']['trj_golem_make']->helper_text='The manufacturer of the vehicle';
		...
		$trj_golem_data['script']['form']['trj_golem_save']->value='Save';
